...
#this is just a one time to fix the fire anamation subbmited with wrong deminsions
def fix_fire(imgpath):
    img = Image.open(imgpath)  # Can be many different formats.
    pic = img.load()
    frames = 17
...
if __name__ == '__main__':
    ...
    # convert_right_advance('img/fire.bmp').save('img/fire.png') # example of use for exporting to other programs
    convert_down_advance('img/THEBIGONE.png').save('img/THEBIGONE_fixed.png') # example of use for importing from other programs
    # fix_fire('img/fire.bmp').save('img/fire.png')
